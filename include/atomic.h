 ...
 * 
* atomic utilities functions
*
* Author(s): wxlin  <linweixuangz@126.com>
*
* $Id:atomic.h,v 1.4 2008-12-30 08:14:55 wxlin Exp $
*
*/
 ...
 */
static __inline__ unsigned int atomic_add_return(int i, atomic_t *v)
{
  int __i;
...
static __inline__ unsigned int atomic_sub_return(int i, atomic_t *v)
{
